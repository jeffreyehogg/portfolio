		...
		<div className='relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950 pt-20 pb-16'>
			...
			<div className='relative z-10 px-4 sm:px-6 lg:px-8 text-center max-w-5xl mx-auto'>
				...
				>
					...
					<h1 className='text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl mb-6 text-white text-balance'>
					...
					<p className='mt-6 text-lg sm:text-xl text-slate-300 sm:max-w-2xl mx-auto leading-relaxed font-light text-balance'>
				...
				{/* Action Buttons */}
				<motion.div
					className='mt-8 sm:mt-10 flex flex-wrap gap-4 justify-center items-center'
				...
				>
					...
					<a
						...
						className='group inline-flex items-center gap-2 px-6 py-3 text-sm sm:text-base font-medium rounded-xl text-slate-300 border border-slate-800 bg-slate-900/60 hover:bg-slate-800/90 hover:text-white backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5'
					>
				...
				<motion.div
					...
					initial={shouldReduce ? false : { opacity: 0, y: 20 }}
					animate={shouldReduce ? undefined : { opacity: 1, y: 0 }}
					transition={{ type: 'spring', bounce: 0.2, duration: 0.7, delay: 0.45 }}
				>
					{metrics.map((item) => (
						<div
							key={item.label}
							className='flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl bg-slate-900/40 border border-slate-800/70 hover:border-indigo-500/30 hover:bg-slate-900/70 hover:shadow-lg hover:shadow-indigo-500/10 hover:-translate-y-0.5 backdrop-blur-sm text-center transition-all duration-200 group cursor-default'
						>
							...
							<div className='text-white font-bold text-sm sm:text-base leading-tight group-hover:text-indigo-200 transition-colors'>
								{item.value}
							</div>
							<div className='text-[10px] sm:text-[11px] font-mono text-slate-400 mt-1 uppercase tracking-wider'>
								{item.label}
							</div>
						</div>
					))}
